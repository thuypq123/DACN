...
export const fetchProfile = createAsyncThunk('profile/fetchProfile', async (payload) => {
    const response = await fetch(`https://backenddacn.onrender.com/profile`,{
        method: 'POST',
        headers: {
...
export const updateProfile = createAsyncThunk('profile/updateProfile', async (payload) => {
    const response = await fetch(`https://backenddacn.onrender.com/profile/updateprofile`,{
        method: 'POST',
        headers: {
            'Content-Type': 'application/json'
        },
...
export const getOdersProfile = createAsyncThunk('profile/getOdersProfile', async (payload) => {
    const response = await fetch(`https://backenddacn.onrender.com/profile/getOrdersProfile`,{
        method: 'POST',
        headers: {
